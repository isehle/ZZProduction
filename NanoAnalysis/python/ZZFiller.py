...
class ZZFiller(Module):
    ...
    def beginFile(self, inputFile, outputFile, inputTree, wrappedOutputTree):
        ...
        self.out.branch("ZCand_pt", "F", lenVar="nZCand", title="pt")
        self.out.branch("ZCand_eta", "F", lenVar="nZCand", title="eta")
        self.out.branch("ZCand_phi", "F", lenVar="nZCand", title="phi")
        ...
        self.out.branch("ZZCand_pt", "F", lenVar="nZZCand", title="pt")
        self.out.branch("ZZCand_eta", "F", lenVar="nZZCand", title="eta")
        self.out.branch("ZZCand_phi", "F", lenVar="nZZCand", title="phi")
